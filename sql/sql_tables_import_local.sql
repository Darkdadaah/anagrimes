...
LOAD /* SLOW_OK */ DATA LOCAL INFILE '/data/project/anagrimes/data/tables/current_articles.csv'
...
LOAD /* SLOW_OK */ DATA LOCAL INFILE '/data/project/anagrimes/data/tables/current_mots.csv'
...
LOAD DATA LOCAL INFILE '/data/project/anagrimes/data/tables/current_langues.csv'
